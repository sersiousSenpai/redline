...
import type { RevisionEdit } from "./sectionMaps";

// The pure section-tree projections live in sectionMaps.ts (no editor deps —
// App reaches blockIdByAnchorId there without dragging this module's Tiptap
// chain onto the main chunk). Re-exported so editor-side callers keep one
// import path for the doc model.
export {
  anchorByBlockId,
  blockIdByAnchorId,
