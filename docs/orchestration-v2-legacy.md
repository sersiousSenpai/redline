# Historical Orchestrate v2 contract

Archived for interpreting old Workflow runs in History. New runs use the native runner and the executor contract in `skills/orchestrate/SKILL.md`. This document is not an execution instruction.
